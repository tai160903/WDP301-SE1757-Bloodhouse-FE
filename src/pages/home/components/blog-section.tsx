  ...
  const blogPosts = [
    {
      ...
      excerpt: "Ban đầu tôi khá lo lắng, nhưng đội ngũ nhân viên đã giúp tôi cảm thấy thoải mái trong suốt quá trình.",
    ...
    },
    {
      ...
      excerpt: "Hãy cùng làm rõ một số hiểu lầm phổ biến nhất về việc hiến máu.",
  ...
  return (
    <section className="container py-16 space-y-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h2 className="text-3xl font-bold tracking-tight text-red-600">Câu chuyện & Tài nguyên</h2>
          <p className="text-muted-foreground mt-2">Đọc trải nghiệm và tìm hiểu thêm về hiến máu</p>
        </div>
        ...
        {blogPosts.map((post) => (
          <Card key={post.id} className="overflow-hidden card-hover">
            ...
            <CardHeader className="space-y-1">
              ...
              <CardDescription>Tác giả: {post.author}</CardDescription>
            </CardHeader>
            <CardContent>
