            ...
            render={({ field }) => (
              <FormItem>
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                  <FormControl>
                    <SelectTrigger aria-label="Chọn nhóm máu">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                  <FormControl>
                    <SelectTrigger aria-label="Chọn thành phần máu">
                ...
                <FormDescription>Chỉ định thành phần máu cần thiết</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex flex-col">
                ...
                <FormDescription>Thời gian cần máu (tối đa 30 ngày)</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>Tên người liên hệ về yêu cầu này</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>Cung cấp chi tiết về lý do yêu cầu này khẩn cấp</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
          ...
          render={({ field }) => (
            <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
              ...
              <div className="space-y-1 leading-none">
                <FormLabel>
                  Tôi xác nhận tất cả thông tin được cung cấp là chính xác và đầy đủ
                </FormLabel>
                <FormDescription>
                  Bằng cách đánh dấu vào ô này, bạn đồng ý với việc xử lý yêu cầu này và
                  chia sẻ thông tin liên quan với người hiến máu tiềm năng.
                </FormDescription>
              </div>
              <FormMessage />
            </FormItem>
