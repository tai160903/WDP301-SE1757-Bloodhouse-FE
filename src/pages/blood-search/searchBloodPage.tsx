    ...
    <div className="container py-10 space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Tìm kiếm loại máu tương thích và người hiến máu
        </p>
      </div>
      ...
      <Alert>
        ...
        <AlertDescription>
          Sử dụng công cụ tìm kiếm để tìm kiếm loại máu tương thích hoặc tìm
          kiếm những người hiến máu trong khu vực của bạn. Đối với nhu cầu khẩn
          cấp, vui lòng liên hệ với cơ sở y tế trực tiếp hoặc gửi yêu cầu máu
          khẩn cấp.
        </AlertDescription>
      </Alert>
        ...
        <TabsContent value="compatibility">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Tìm kiếm loại máu tương thích cho truyền máu
              </CardDescription>
            </CardHeader>
            <CardContent>
              <BloodTypeSearch />
        ...
        <TabsContent value="donors">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Tìm kiếm người hiến máu theo vị trí và loại máu
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DonorSearch />
