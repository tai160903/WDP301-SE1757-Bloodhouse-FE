  ...
  return (
    <div className="container py-10 space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-2">Lên lịch cho buổi hiến máu của bạn</p>
      </div>
      ...
      <Alert>
        ...
        <AlertDescription>
          Vui lòng đảm bảo bạn đáp ứng các tiêu chí trước khi đăng ký. Bạn phải ít nhất 18 tuổi, nặng ít nhất 50kg, và có sức khỏe tốt. Bạn không nên hiến máu nếu đã hiến trong vòng 56 ngày qua.
        </AlertDescription>
      </Alert>
        ...
        <TabsContent value="schedule">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Điền thông tin dưới đây để đăng ký buổi hiến máu</CardDescription>
            </CardHeader>
            <CardContent>
              <BloodDonationRegistrationForm onSuccess={handleFormSuccess} onError={handleFormError} />
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="eligibility">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Kiểm tra xem bạn có đủ điều kiện hiến máu không</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div>
                <h3 className="font-semibold text-lg">Không đủ điều kiện vĩnh viễn</h3>
                <ul className="list-disc pl-5 mt-2 space-y-1">
