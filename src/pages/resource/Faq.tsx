      ...
      <div className="relative w-full max-w-4xl p-0">
        ...
        src="https://cdn4.iconfinder.com/data/icons/medical-115/60/medical-flat-098-heart-beat-512.png"  
            ...
            <div className="md:w-1/2">
              <h2 className="text-2xl font-bold text-red-600 mb-4">Câu Hỏi Thường Gặp</h2>
              <Accordion type="single" collapsible className="space-y-3">
                <AccordionItem value="1">
                  ...
                  <AccordionContent className="text-gray-600 text-sm">
                    Người khỏe mạnh từ 18-60 tuổi, cân nặng trên 45kg (nữ) hoặc 50kg (nam), không mắc bệnh truyền nhiễm như HIV, viêm gan B/C.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="2">
                  ...
                  <AccordionContent className="text-gray-600 text-sm">
                    Bạn có thể hiến máu toàn phần mỗi 3 tháng một lần, hoặc theo hướng dẫn của bác sĩ đối với các loại hiến máu khác như tiểu cầu.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="3">
                  <AccordionTrigger className="text-gray-800 hover:text-red-600">
                    <span className="flex items-center gap-2">
                      <svg className="w-5 h-5 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 17V7m0 10h6m-6 0H3m6 0h6m0-10h6m-6 0H9" />
                      </svg>
                      Hiến máu có ảnh hưởng đến sức khỏe không?
                    </span>
                  </AccordionTrigger>
                  <AccordionContent className="text-gray-600 text-sm">
                    Không, hiến máu an toàn nếu bạn đủ điều kiện. Cơ thể tái tạo máu trong 48 giờ, và hiến máu còn giúp cải thiện tuần hoàn máu.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="4">
                  ...
                  <AccordionContent className="text-gray-600 text-sm">
                    Ngủ đủ giấc, ăn sáng nhẹ, uống nhiều nước và tránh rượu bia trước khi hiến máu để đảm bảo sức khỏe tốt.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="5">
                  ...
                  <AccordionContent className="text-gray-600 text-sm">
                    Máu hiến được dùng trong phẫu thuật, điều trị ung thư, tai nạn hoặc các bệnh lý như thiếu máu, đảm bảo cứu sống nhiều người.
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </div>
