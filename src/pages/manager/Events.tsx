...
export default function Events() {
  ...
  const onSubmit = async (data: EventFormData) => {
    ...
    try {
      ...
      formData.append('expectedParticipants', data.expectedParticipants.toString());
    ...
    <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="grid gap-2">
                    ...
                    {errors.expectedParticipants && (
                      <p className="text-sm text-red-500">{errors.expectedParticipants.message}</p>
                    )}
                  </div>
                  <div className="grid gap-2">
                    <Label htmlFor="isPublic">Visibility</Label>
                    <Select onValueChange={(value) => setValue("isPublic", value === "true")}>
                      <SelectTrigger>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage upcoming and past blood donation events</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
                ...
                <TableRow key={event.id}>
                  ...
                  <TableCell>
                    <div className="flex items-center">
                      ...
                      {event.registeredParticipants}/{event.expectedParticipants}
                    </div>
                  </TableCell>
